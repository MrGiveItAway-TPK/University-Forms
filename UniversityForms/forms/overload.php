...
<html>
	...
	<body class="loggedin">
		...
		<div class="content">
			<h2>Approval Of Overloading Study-Hours, <?=$Name?></h2>
			...
			<form action="../formsend.php" method="post">
				...
				<input type="text" name="reqhours" placeholder="Requested Study-Hours" class="clear" required><br>
				<input type="text" name="gpa" placeholder="Your Current GPA" class="clear" required><br>
				<input type="text" name="expecY" placeholder="Expected Graduation Year And Semester" class="clear" required><br>
				<textarea rows = "10" cols = "100" name = "Description" placeholder="Reason..." class="clear"></textarea><br>
				<input type="text" name="Type" value="Overload" readonly required hidden><br>
