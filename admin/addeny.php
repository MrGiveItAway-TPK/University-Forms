...
if (isset($_POST['sub'])) {
	...
	$result = mysqli_query($con, "UPDATE forms SET adstatus='Denied' WHERE id = $id");
	$result2 = mysqli_query($con, "UPDATE forms SET adreason='$comment' WHERE id = $id");
	$result3 = mysqli_query($con, "UPDATE forms SET hodstatus='------' WHERE id = $id");
	$result4 = mysqli_query($con, "UPDATE forms SET hodreason='------' WHERE id = $id");
