...
<html>
	...
	<body class="loggedin">
		...
		<div class="content">
			<h2>Applying For A Closed Divison, <?=$Name?></h2>
			...
			<form action="../formsend.php" method="post">
				...
				<input type="text" name="CourseNumber" placeholder="Course Number" class="clear" required><br>
				<input type="text" name="CourseName" placeholder="Course Name" class="clear" required><br>
				<input type="text" name="CourseDNumber" placeholder="Course Divison Number" class="clear"required><br>
				<input type="text" name="Type" value="Closed Divion" readonly required hidden><br>
